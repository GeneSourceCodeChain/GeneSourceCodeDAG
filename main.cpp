...
int main()
{
	...
	ProducerNode producer1("prod1",keypair1,{boost::make_tuple("localhost",8888)},"localhost",9011); producer1.run();
	ProducerNode producer2("prod2",keypair2,{boost::make_tuple("localhost",8888)},"localhost",9012); producer2.run();
	ProducerNode producer3("prod3",keypair3,{boost::make_tuple("localhost",8888)},"localhost",9013); producer3.run();
	ProducerNode producer4("prod4",keypair4,{boost::make_tuple("localhost",8888)},"localhost",9014); producer4.run();
	//2)voting
